  ...
  <nav class="navbar navbar-dark bg-dark navbar-expand-lg menu">
    ...
    <div class="collapse navbar-collapse" id="menu">
      <ul class="navbar-nav mr-auto">
        ...
        <?php if (isset($_SESSION['Admin'])) : ?>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="merma" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fas fa-users pr-1"></i>Usuarios
            </a>
            <div class="dropdown-menu" aria-labelledby="merma">
              ...
              <a class="dropdown-item" href="#">Alguna Monda</a>
            </div>
          </li>
        <?php endif; ?>
        <li class="nav-item dropdown">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= baseUrl; ?>usuario/logout"><i class="fas fa-door-open"></i> Salir</a>
        </li>
      </ul>
    </div>
  </nav>
